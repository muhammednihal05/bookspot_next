...
import { exchangeBook } from '../../../lib/supabase.helper';
import styles from '../../../styles/JoinAuction.module.css'; 
...
export default function JoinAuction() {
    ...
    const onSubmit = data => {
        ...
        exchangeBook({data: data, sellingBookId: router?.query?.auctionId, seterror: seterror, setloading: setloading, router: router})
      }
